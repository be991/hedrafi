      ...
      <main className="relative max-w-7xl mx-auto px-6 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Manage and organize your NFT collections</p>
          </div>
          <button
            disabled
            className="bg-gradient-to-r from-purple-500 to-indigo-600 px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg opacity-50 cursor-not-allowed"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {collections.map((collection) => (
              <div
                ...
                className="backdrop-blur-xl bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-2xl border border-purple-500/20 overflow-hidden hover:border-purple-500/50 transition-all duration-300 hover:scale-105 shadow-xl cursor-pointer group"
              >
                {/* Banner */}
                ...
                <div className="p-4 pt-2">
                  ...
                  <p className="text-sm text-purple-300 mb-2">{collection.symbol}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-gray-900/50 p-2 rounded-lg">
                      ...
                      <div className="font-bold">{collection.royalty}%</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      >
        {selectedCollection && (
          <div className="space-y-6">
            {/* Banner */}
            <div className="relative h-48 rounded-xl overflow-hidden bg-gradient-to-br from-purple-500/20 to-indigo-500/20">
              <img 
            ...
            <div className="flex items-start gap-4">
              <div className="w-24 h-24 rounded-xl overflow-hidden bg-gray-800 border-2 border-purple-500/30 flex-shrink-0">
                <img 
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold mb-1">{selectedCollection.name}</h2>
                <p className="text-purple-300 font-semibold mb-2">{selectedCollection.symbol}</p>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-gray-900/50 p-4 rounded-xl text-center">
                ...
                <div className="text-2xl font-bold">{selectedCollection.items}</div>
              </div>
              <div className="bg-gray-900/50 p-4 rounded-xl text-center">
                <div className="text-sm text-gray-400 mb-1">Royalty</div>
                <div className="text-2xl font-bold">{selectedCollection.royalty}%</div>
              </div>
              <div className="bg-gray-900/50 p-4 rounded-xl text-center">
            ...
            <div className="flex gap-4">
              <button
                disabled
                className="flex-1 bg-purple-500/20 border border-purple-500/50 text-purple-200 px-6 py-3 rounded-xl font-semibold transition-all opacity-60 cursor-not-allowed"
              >
                Add NFT to Collection
              </button>
              <button
                disabled
                className="flex-1 bg-indigo-500/20 border border-indigo-500/50 text-indigo-200 px-6 py-3 rounded-xl font-semibold transition-all opacity-60 cursor-not-allowed"
              >
                Edit Collection
              </button>
            </div>
